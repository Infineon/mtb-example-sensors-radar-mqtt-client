...
struct IotNetworkServerInfo networkServerInfo = {.pHostName = MQTT_BROKER_ADDRESS, .port = MQTT_PORT};
...
IotMqttNetworkInfo_t networkInfo = {.createNetworkConnection = true,
 ...
 */
IotMqttPublishInfo_t willInfo = {.qos = IOT_MQTT_QOS_0,
...
IotMqttConnectInfo_t connectionInfo = {.cleanSession = true,
